...
export function sys_debug(game: Game, delta: number) {
    ...
    for (let [key, wireframe] of wireframes) {
        if (
            ...
            !(game.World.Components[wireframe.anchor_entity] & Has.Transform) ||
