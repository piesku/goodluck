...
import {mesh_MonkeyFlat} from "../shapes/MonkeyFlat.js";
import {mesh_MonkeySmooth} from "../shapes/MonkeySmooth.js";
...
export class Game {
    ...
    constructor() {
        ...
        this.MeshMonkeyFlat = mesh_MonkeyFlat(this.GL);
        this.MeshMonkeySmooth = mesh_MonkeySmooth(this.GL);
    }
